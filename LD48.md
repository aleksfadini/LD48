...
- [ ] create one menu callout prefab
- [ ] create one text callout
- [ ] add spacebar and button to pause
- [ ] when winning, count how many flies
- [ ] add attractor powerup once poop reaches certain level
- [ ] add flies powerup once poop reaches certain level
- [ ] add powerup choice
- [ ] add settings choice
