...
- [x] create start of level with flies spawn
- [x] create exit to ending - win condition
- [x] implement lose conditions when flies count reaches zero
- [x] add menu to restart
- [N] make flies survive if they eat poop ( and give you energy)

### secondary things
- [ ] create nice poop meter
- [ ] pus somewhere EGGS ABUND IN THE DEEP, BUT LACK IN THE TOP
- [ ] find a way to send message. maybe pause with "a fly says...", or maybe before choosing power
- [ ] explain better!!! with messages
- [ ] make title screen
- [x] create eggs
- [x] make flies hatch if you pick up white thing (egg)
- [x] create one menu callout prefab
- [x] create one text callout
- [N] add spacebar and button to pause
- [ ] when winning, count how many flies
- [x] add attractor powerup once poop reaches certain level
- [x] add flies powerup once poop reaches certain level
- [x] add powerup choice
- [ ] add settings choice in menu
- [ ] add randomization or fixed level (if rand flag, randomize)
- [ ] need to create indestructible tiles around borders
- [x] maybe single level? But very hard upwards? You start in the center!!!
- [x] make tiles breakables
- [x] make procedurally generated tiles (test)
- [x] show damage of flies with alpha (test!)
- [ ] make introduction
- [ ] randomize dialogs for win and lose
- [ ] add music opening
- [ ] add sfx
...
- find general score
- review sky palette
- [x] add stages explanation to fly (start small, then bigger, then gray big, then gray small, then die)
...
- [x] put colored Rect as bg and change it based on cam height
